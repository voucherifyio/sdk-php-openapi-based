...
/**
     ...
     * @param  \OpenAPI\Client\Model\VouchersCreateWithWithSpecificCodeRequestBody $vouchers_create_with_with_specific_code_request_body Specify the details of the voucher that you would like to create. (optional)
     ...
     */
    public function createVoucher($code, $vouchers_create_with_with_specific_code_request_body = null, string $contentType = self::contentTypes['createVoucher'][0])
    {
     ...
     */
    public function createVoucherWithHttpInfo($code, $vouchers_create_with_with_specific_code_request_body = null, string $contentType = self::contentTypes['createVoucher'][0])
    {
     ...
     */
    public function createVoucherAsync($code, $vouchers_create_with_with_specific_code_request_body = null, string $contentType = self::contentTypes['createVoucher'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createVoucherAsyncWithHttpInfo($code, $vouchers_create_with_with_specific_code_request_body = null, string $contentType = self::contentTypes['createVoucher'][0])
    {
        $returnType = '\OpenAPI\Client\Model\VouchersCreateResponseBody';
        $request = $this->createVoucherRequest($code, $vouchers_create_with_with_specific_code_request_body, $contentType);
     ...
     */
    public function createVoucherRequest($code, $vouchers_create_with_with_specific_code_request_body = null, string $contentType = self::contentTypes['createVoucher'][0])
    {
     ...
     */
    public function listVouchers($limit = null, $page = null, $category = null, $campaign_id = null, $customer = null, $campaign = null, $created_at = null, $updated_at = null, $order = null, string $contentType = self::contentTypes['listVouchers'][0])
    {
     ...
     */
    public function listVouchersWithHttpInfo($limit = null, $page = null, $category = null, $campaign_id = null, $customer = null, $campaign = null, $created_at = null, $updated_at = null, $order = null, string $contentType = self::contentTypes['listVouchers'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listVouchersAsync($limit = null, $page = null, $category = null, $campaign_id = null, $customer = null, $campaign = null, $created_at = null, $updated_at = null, $order = null, string $contentType = self::contentTypes['listVouchers'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listVouchersAsyncWithHttpInfo($limit = null, $page = null, $category = null, $campaign_id = null, $customer = null, $campaign = null, $created_at = null, $updated_at = null, $order = null, string $contentType = self::contentTypes['listVouchers'][0])
    {
        $returnType = '\OpenAPI\Client\Model\VouchersListResponseBody';
        $request = $this->listVouchersRequest($limit, $page, $category, $campaign_id, $customer, $campaign, $created_at, $updated_at, $order, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listVouchersRequest($limit = null, $page = null, $category = null, $campaign_id = null, $customer = null, $campaign = null, $created_at = null, $updated_at = null, $order = null, string $contentType = self::contentTypes['listVouchers'][0])
    {
