...
class RedemptionsApi
{
    ...
    public function getRedemption(
        ...
        string $contentType = self::contentTypes['getRedemption'][0]
     ...
     */
    public function getRedemptionWithHttpInfo(
        string $redemption_id,
        string $contentType = self::contentTypes['getRedemption'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\RedemptionsGetResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getRedemptionAsync(
        string $redemption_id,
        string $contentType = self::contentTypes['getRedemption'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getRedemptionAsyncWithHttpInfo(
        $redemption_id,
        string $contentType = self::contentTypes['getRedemption'][0]
    ): PromiseInterface
    {
     ...
     */
    public function getVoucherRedemptions(
        string $code,
        string $contentType = self::contentTypes['getVoucherRedemptions'][0]
     ...
     */
    public function getVoucherRedemptionsWithHttpInfo(
        string $code,
        string $contentType = self::contentTypes['getVoucherRedemptions'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\VouchersRedemptionGetResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getVoucherRedemptionsAsync(
        string $code,
        string $contentType = self::contentTypes['getVoucherRedemptions'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getVoucherRedemptionsAsyncWithHttpInfo(
        $code,
        string $contentType = self::contentTypes['getVoucherRedemptions'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVoucherRedemptionsRequest(
        $code,
        string $contentType = self::contentTypes['getVoucherRedemptions'][0]
    ): Request
    {
     ...
     * @param  string|null $result A filter on the list based on the redemption result. Available options are: SUCCESS, FAILURE. You can provide multiple values by repeating the param. (optional)
     * @param  string|null $campaign A filter by the campaign **name** that the redemption resources originate from. (optional)
     * @param  string|null $customer Return redemptions performed by the customer with given id or source_id. (optional)
     * @param  ParameterOrderListRedemptions|null $order Sorts the results using one of the filtering options, where the dash - preceding a sorting option means sorting in a descending order. (optional)
     ...
     * @param  ParameterFiltersListRedemptions|null $filters Filters for listing responses. (optional)
    ...
    public function listRedemptions(
        ...
        ?ParameterOrderListRedemptions $order = null,
        ?ParameterCreatedBeforeAfter $created_at = null,
        ?ParameterFiltersListRedemptions $filters = null,
        string $contentType = self::contentTypes['listRedemptions'][0]
     ...
     */
    public function listRedemptionsWithHttpInfo(
        ?int $limit = null,
        ?int $page = null,
        ?string $result = null,
        ?string $campaign = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\RedemptionsListResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function listRedemptionsAsync(
        ?int $limit = null,
        ?int $page = null,
        ?string $result = null,
        ?string $campaign = null,
     ...
     * @return PromiseInterface
     */
    public function listRedemptionsAsyncWithHttpInfo(
        $limit = null,
        $page = null,
        $result = null,
        $campaign = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listRedemptionsRequest(
        $limit = null,
        $page = null,
        $result = null,
        $campaign = null,
     ...
     *
     * @param  \OpenAPI\Client\Model\RedemptionsRedeemRequestBody|null $redemptions_redeem_request_body redemptions_redeem_request_body (optional)
     ...
     */
    public function redeemStackedDiscounts(
        ?\OpenAPI\Client\Model\RedemptionsRedeemRequestBody $redemptions_redeem_request_body = null,
        string $contentType = self::contentTypes['redeemStackedDiscounts'][0]
     ...
     * Redeem Stackable Discounts
     *
     * @param  \OpenAPI\Client\Model\RedemptionsRedeemRequestBody|null $redemptions_redeem_request_body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['redeemStackedDiscounts'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     ...
     */
    public function redeemStackedDiscountsWithHttpInfo(
        ?\OpenAPI\Client\Model\RedemptionsRedeemRequestBody $redemptions_redeem_request_body = null,
        string $contentType = self::contentTypes['redeemStackedDiscounts'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\RedemptionsRedeemResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function redeemStackedDiscountsAsync(
        ?\OpenAPI\Client\Model\RedemptionsRedeemRequestBody $redemptions_redeem_request_body = null,
        string $contentType = self::contentTypes['redeemStackedDiscounts'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function redeemStackedDiscountsAsyncWithHttpInfo(
        $redemptions_redeem_request_body = null,
        string $contentType = self::contentTypes['redeemStackedDiscounts'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\RedemptionsRedeemResponseBody';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function redeemStackedDiscountsRequest(
        $redemptions_redeem_request_body = null,
        string $contentType = self::contentTypes['redeemStackedDiscounts'][0]
    ): Request
    {
     ...
     * @param  string|null $reason Reason for the rollback. (optional)
     * @param  string|null $tracking_id Customers source_id. (optional)
     * @param  \OpenAPI\Client\Model\RedemptionsRollbackCreateRequestBody|null $redemptions_rollback_create_request_body Add information about the original customer and order. Customer data and Redemption metadata can be updated in Voucherify when passing the customer data in the request body. (optional)
     ...
     */
    public function rollbackRedemption(
        string $redemption_id,
        ?string $reason = null,
        ?string $tracking_id = null,
        ?\OpenAPI\Client\Model\RedemptionsRollbackCreateRequestBody $redemptions_rollback_create_request_body = null,
        string $contentType = self::contentTypes['rollbackRedemption'][0]
     ...
     */
    public function rollbackRedemptionWithHttpInfo(
        string $redemption_id,
        ?string $reason = null,
        ?string $tracking_id = null,
        ?\OpenAPI\Client\Model\RedemptionsRollbackCreateRequestBody $redemptions_rollback_create_request_body = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\RedemptionsRollbackCreateResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function rollbackRedemptionAsync(
        string $redemption_id,
        ?string $reason = null,
        ?string $tracking_id = null,
        ?\OpenAPI\Client\Model\RedemptionsRollbackCreateRequestBody $redemptions_rollback_create_request_body = null,
     ...
     * @return PromiseInterface
     */
    public function rollbackRedemptionAsyncWithHttpInfo(
        $redemption_id,
        $reason = null,
        $tracking_id = null,
        $redemptions_rollback_create_request_body = null,
        string $contentType = self::contentTypes['rollbackRedemption'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\RedemptionsRollbackCreateResponseBody';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function rollbackRedemptionRequest(
        $redemption_id,
        $reason = null,
        $tracking_id = null,
        $redemptions_rollback_create_request_body = null,
     ...
     * @param  string|null $reason Reason for the rollback. (optional)
     * @param  string|null $tracking_id Customers source_id. (optional)
     * @param  \OpenAPI\Client\Model\RedemptionsRollbacksCreateRequestBody|null $redemptions_rollbacks_create_request_body Add information about the original customer and order. Customer data and Redemption metadata can be updated in Voucherify when passing the customer data in the request body. (optional)
     ...
     */
    public function rollbackStackedRedemptions(
        string $parent_redemption_id,
        ?string $reason = null,
        ?string $tracking_id = null,
        ?\OpenAPI\Client\Model\RedemptionsRollbacksCreateRequestBody $redemptions_rollbacks_create_request_body = null,
        string $contentType = self::contentTypes['rollbackStackedRedemptions'][0]
     ...
     */
    public function rollbackStackedRedemptionsWithHttpInfo(
        string $parent_redemption_id,
        ?string $reason = null,
        ?string $tracking_id = null,
        ?\OpenAPI\Client\Model\RedemptionsRollbacksCreateRequestBody $redemptions_rollbacks_create_request_body = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\RedemptionsRollbacksCreateResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function rollbackStackedRedemptionsAsync(
        string $parent_redemption_id,
        ?string $reason = null,
        ?string $tracking_id = null,
        ?\OpenAPI\Client\Model\RedemptionsRollbacksCreateRequestBody $redemptions_rollbacks_create_request_body = null,
     ...
     * @return PromiseInterface
     */
    public function rollbackStackedRedemptionsAsyncWithHttpInfo(
        $parent_redemption_id,
        $reason = null,
        $tracking_id = null,
        $redemptions_rollbacks_create_request_body = null,
        string $contentType = self::contentTypes['rollbackStackedRedemptions'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\RedemptionsRollbacksCreateResponseBody';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function rollbackStackedRedemptionsRequest(
        $parent_redemption_id,
        $reason = null,
        $tracking_id = null,
        $redemptions_rollbacks_create_request_body = null,
