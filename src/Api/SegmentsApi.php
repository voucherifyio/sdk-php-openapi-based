...
class SegmentsApi
{
     ...
     * Create Segment
     *
     * @param  \OpenAPI\Client\Model\SegmentsCreateRequestBody|null $segments_create_request_body Specify the boundary conditions for the customer segment. (optional)
    ...
    public function createSegment(
        ?\OpenAPI\Client\Model\SegmentsCreateRequestBody $segments_create_request_body = null,
        string $contentType = self::contentTypes['createSegment'][0]
     ...
     */
    public function createSegmentWithHttpInfo(
        ?\OpenAPI\Client\Model\SegmentsCreateRequestBody $segments_create_request_body = null,
        string $contentType = self::contentTypes['createSegment'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\SegmentsCreateResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function createSegmentAsync(
        ?\OpenAPI\Client\Model\SegmentsCreateRequestBody $segments_create_request_body = null,
        string $contentType = self::contentTypes['createSegment'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function createSegmentAsyncWithHttpInfo(
        $segments_create_request_body = null,
        string $contentType = self::contentTypes['createSegment'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\SegmentsCreateResponseBody';
     ...
     */
    public function createSegmentRequest(
        $segments_create_request_body = null,
        string $contentType = self::contentTypes['createSegment'][0]
    ): Request
    {
    ...
    public function deleteSegment(
        string $segment_id,
        string $contentType = self::contentTypes['deleteSegment'][0]
    ): void
    {
     ...
     */
    public function deleteSegmentWithHttpInfo(
        string $segment_id,
        string $contentType = self::contentTypes['deleteSegment'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function deleteSegmentAsync(
        string $segment_id,
        string $contentType = self::contentTypes['deleteSegment'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function deleteSegmentAsyncWithHttpInfo(
        $segment_id,
        string $contentType = self::contentTypes['deleteSegment'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSegmentRequest(
        $segment_id,
        string $contentType = self::contentTypes['deleteSegment'][0]
    ): Request
    {
    ...
    public function getSegment(
        string $segment_id,
        string $contentType = self::contentTypes['getSegment'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\SegmentsGetResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSegmentRequest(
        $segment_id,
        string $contentType = self::contentTypes['getSegment'][0]
    ): Request
    {
