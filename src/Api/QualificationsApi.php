...
class QualificationsApi
{
     ...
     * Check Eligibility
     *
     * @param  \OpenAPI\Client\Model\QualificationsCheckEligibilityRequestBody|null $qualifications_check_eligibility_request_body Define order and customer context. (optional)
    ...
    public function checkEligibility(
        ?\OpenAPI\Client\Model\QualificationsCheckEligibilityRequestBody $qualifications_check_eligibility_request_body = null,
        string $contentType = self::contentTypes['checkEligibility'][0]
    ): \OpenAPI\Client\Model\QualificationsCheckEligibilityResponseBody
    {
     ...
     */
    public function checkEligibilityWithHttpInfo(
        ?\OpenAPI\Client\Model\QualificationsCheckEligibilityRequestBody $qualifications_check_eligibility_request_body = null,
        string $contentType = self::contentTypes['checkEligibility'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\QualificationsCheckEligibilityResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\QualificationsCheckEligibilityResponseBody' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\QualificationsCheckEligibilityResponseBody', []),
     ...
     * @return PromiseInterface
     */
    public function checkEligibilityAsyncWithHttpInfo(
        $qualifications_check_eligibility_request_body = null,
        string $contentType = self::contentTypes['checkEligibility'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\QualificationsCheckEligibilityResponseBody';
     ...
     */
    public function checkEligibilityRequest(
        $qualifications_check_eligibility_request_body = null,
        string $contentType = self::contentTypes['checkEligibility'][0]
    ): Request
    {
        ...
        $resourcePath = '/v1/qualifications';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
