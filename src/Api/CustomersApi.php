...
/**
     ...
     *
     * @param  \OpenAPI\Client\Model\CustomersUpdateInBulkRequestBody[] $customers_update_in_bulk_request_body Specify the customer fields that you would like to update in each customer object. (optional)
