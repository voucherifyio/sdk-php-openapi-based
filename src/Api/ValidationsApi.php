...
class ValidationsApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\ValidationsValidateRequestBody|null $validations_validate_request_body validations_validate_request_body (optional)
     ...
     */
    public function validateStackedDiscounts(
        ?\OpenAPI\Client\Model\ValidationsValidateRequestBody $validations_validate_request_body = null,
        string $contentType = self::contentTypes['validateStackedDiscounts'][0]
     ...
     * Validate Stackable Discounts
     *
     * @param  \OpenAPI\Client\Model\ValidationsValidateRequestBody|null $validations_validate_request_body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['validateStackedDiscounts'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     ...
     */
    public function validateStackedDiscountsWithHttpInfo(
        ?\OpenAPI\Client\Model\ValidationsValidateRequestBody $validations_validate_request_body = null,
        string $contentType = self::contentTypes['validateStackedDiscounts'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\ValidationsValidateResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function validateStackedDiscountsAsync(
        ?\OpenAPI\Client\Model\ValidationsValidateRequestBody $validations_validate_request_body = null,
        string $contentType = self::contentTypes['validateStackedDiscounts'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function validateStackedDiscountsAsyncWithHttpInfo(
        $validations_validate_request_body = null,
        string $contentType = self::contentTypes['validateStackedDiscounts'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\ValidationsValidateResponseBody';
     ...
     */
    public function validateStackedDiscountsRequest(
        $validations_validate_request_body = null,
        string $contentType = self::contentTypes['validateStackedDiscounts'][0]
    ): Request
    {
