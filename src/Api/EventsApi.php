...
class EventsApi
{
     ...
     * Track Custom Event
     *
     * @param  \OpenAPI\Client\Model\EventsCreateRequestBody|null $events_create_request_body Specify the details of the custom event. (optional)
    ...
    public function trackCustomEvent(
        ?\OpenAPI\Client\Model\EventsCreateRequestBody $events_create_request_body = null,
        string $contentType = self::contentTypes['trackCustomEvent'][0]
     ...
     */
    public function trackCustomEventWithHttpInfo(
        ?\OpenAPI\Client\Model\EventsCreateRequestBody $events_create_request_body = null,
        string $contentType = self::contentTypes['trackCustomEvent'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\EventsCreateResponseBody', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function trackCustomEventAsync(
        ?\OpenAPI\Client\Model\EventsCreateRequestBody $events_create_request_body = null,
        string $contentType = self::contentTypes['trackCustomEvent'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function trackCustomEventAsyncWithHttpInfo(
        $events_create_request_body = null,
        string $contentType = self::contentTypes['trackCustomEvent'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\EventsCreateResponseBody';
     ...
     */
    public function trackCustomEventRequest(
        $events_create_request_body = null,
        string $contentType = self::contentTypes['trackCustomEvent'][0]
    ): Request
    {
