...
/**
 * AsyncActionGetResponseBody Class Doc Comment
 *
 * @description Response body schema for **GET** &#x60;/async-actions/{asyncActionId}&#x60;.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class AsyncActionGetResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AsyncActionGetResponseBody';
    ...
    */
    ...
    public function setProgress(?int $progress): static
    {
        ...
        if (!is_null($progress) && ($progress > 100)) {
            throw new InvalidArgumentException('invalid value for $progress when calling AsyncActionGetResponseBody., must be smaller than or equal to 100.');
        }
        if (!is_null($progress) && ($progress < 0)) {
            throw new InvalidArgumentException('invalid value for $progress when calling AsyncActionGetResponseBody., must be bigger than or equal to 0.');
        }
