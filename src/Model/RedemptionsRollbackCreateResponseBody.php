...
class RedemptionsRollbackCreateResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RedemptionsRollbackCreateResponseBody';
    ...
    */
     ...
     */
    public function getRelatedRedemptions(): ?\OpenAPI\Client\Model\RedemptionRollbackRelatedRedemptions
    {
     ...
     * @return $this
     */
    public function setRelatedRedemptions(?\OpenAPI\Client\Model\RedemptionRollbackRelatedRedemptions $related_redemptions): static
    {
     ...
     */
    public function getChannel(): ?\OpenAPI\Client\Model\RedemptionRollbackChannel
    {
     ...
     * @return $this
     */
    public function setChannel(?\OpenAPI\Client\Model\RedemptionRollbackChannel $channel): static
    {
        if (is_null($channel)) {
     ...
     */
    public function getVoucher(): ?\OpenAPI\Client\Model\Voucher
    {
     ...
     * Sets voucher
     *
     * @param \OpenAPI\Client\Model\Voucher|null $voucher Defines the details of the voucher being originally redeemed.
     *
     * @return $this
     */
    public function setVoucher(?\OpenAPI\Client\Model\Voucher $voucher): static
    {
        if (is_null($voucher)) {
     ...
     */
    public function getGift(): ?\OpenAPI\Client\Model\RedemptionRollbackGift
    {
     ...
     * @return $this
     */
    public function setGift(?\OpenAPI\Client\Model\RedemptionRollbackGift $gift): static
    {
        if (is_null($gift)) {
     ...
     */
    public function getLoyaltyCard(): ?\OpenAPI\Client\Model\RedemptionRollbackLoyaltyCard
    {
     ...
     * @return $this
     */
    public function setLoyaltyCard(?\OpenAPI\Client\Model\RedemptionRollbackLoyaltyCard $loyalty_card): static
    {
