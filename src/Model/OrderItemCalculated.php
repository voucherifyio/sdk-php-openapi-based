...
/**
 * OrderItemCalculated Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class OrderItemCalculated implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderItemCalculated';
    ...
    */
     ...
     */
    public function getProduct(): ?\OpenAPI\Client\Model\OrderItemCalculatedProduct
    {
     ...
     * @return $this
     */
    public function setProduct(?\OpenAPI\Client\Model\OrderItemCalculatedProduct $product): static
    {
        if (is_null($product)) {
     ...
     */
    public function getSku(): ?\OpenAPI\Client\Model\OrderItemCalculatedSku
    {
     ...
     * @return $this
     */
    public function setSku(?\OpenAPI\Client\Model\OrderItemCalculatedSku $sku): static
    {
        if (is_null($sku)) {
