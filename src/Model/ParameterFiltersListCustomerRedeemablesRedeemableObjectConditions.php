...
/**
 * ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParameterFiltersListCustomerRedeemablesRedeemableObject_conditions';
...
>>>>>>> Stashed changes:src/Model/ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.php
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is', $data ?? [], 'voucher');
        $this->setIfExists('is_not', $data ?? [], 'voucher');
