 ...
 */
class ExportsGetResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ExportsGetResponseBody';
    ...
    */
     ...
     */
    public function getResult(): ?\OpenAPI\Client\Model\ExportResult
    {
     ...
     * @return $this
     */
    public function setResult(?\OpenAPI\Client\Model\ExportResult $result): static
    {
        if (is_null($result)) {
     ...
     */
    public function getParameters(): ?\OpenAPI\Client\Model\ExportParameters
    {
     ...
     * @return $this
     */
    public function setParameters(?\OpenAPI\Client\Model\ExportParameters $parameters): static
    {
