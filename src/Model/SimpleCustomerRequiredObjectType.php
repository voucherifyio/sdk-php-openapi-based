...
/**
 * SimpleCustomerRequiredObjectType Class Doc Comment
 *
 ...
 */
class SimpleCustomerRequiredObjectType implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SimpleCustomerRequiredObjectType';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of a customer that is assigned by Voucherify.
     *
     * @return $this
     */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by the JSON. This object stores information about the customer.
     *
     * @return $this
     */
