...
/**
 * ReferralProgram Class Doc Comment
 *
 ...
 */
class ReferralProgram implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ReferralProgram';
    ...
    public const CONVERSION_EVENT_TYPE_REDEMPTION = 'redemption';
    public const CONVERSION_EVENT_TYPE_CUSTOM_EVENT = 'custom_event';
     ...
     * @return string[]
     */
    public function getConversionEventTypeAllowableValues()
    {
        return [
            self::CONVERSION_EVENT_TYPE_REDEMPTION,
            self::CONVERSION_EVENT_TYPE_CUSTOM_EVENT,
        ];
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getConversionEventType(): ?string
    {
     ...
     * @return $this
     */
    public function setConversionEventType(?string $conversion_event_type): static
    {
     ...
     */
    public function getCustomEvent(): ?\OpenAPI\Client\Model\ReferralProgramCustomEvent
    {
     ...
     * @return $this
     */
    public function setCustomEvent(?\OpenAPI\Client\Model\ReferralProgramCustomEvent $custom_event): static
    {
     ...
     */
    public function getRefereeReward(): ?\OpenAPI\Client\Model\ReferralProgramRefereeReward
    {
     ...
     * @return $this
     */
    public function setRefereeReward(?\OpenAPI\Client\Model\ReferralProgramRefereeReward $referee_reward): static
    {
