...
class RedemptionsListResponseBodyRedemptionsItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Redemptions_List_Response_Body_Redemptions_Item';
    ...
    */
     ...
     */
    public function getRelatedRedemptions(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemRelatedRedemptions
    {
     ...
     * @return $this
     */
    public function setRelatedRedemptions(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemRelatedRedemptions $related_redemptions): static
    {
     ...
     */
    public function getOrder(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemOrder
    {
     ...
     * @return $this
     */
    public function setOrder(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemOrder $order): static
    {
        if (is_null($order)) {
     ...
     */
    public function getChannel(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemChannel
    {
     ...
     * @return $this
     */
    public function setChannel(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemChannel $channel): static
    {
        if (is_null($channel)) {
     ...
     */
    public function getCustomer(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemCustomer
    {
     ...
     * @return $this
     */
    public function setCustomer(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemCustomer $customer): static
    {
        if (is_null($customer)) {
     ...
     */
    public function getVoucher(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucher
    {
     ...
     * @return $this
     */
    public function setVoucher(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucher $voucher): static
    {
        if (is_null($voucher)) {
     ...
     */
    public function getPromotionTier(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemPromotionTier
    {
     ...
     * @return $this
     */
    public function setPromotionTier(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemPromotionTier $promotion_tier): static
    {
     ...
     */
    public function getGift(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemGift
    {
     ...
     * @return $this
     */
    public function setGift(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemGift $gift): static
    {
        if (is_null($gift)) {
     ...
     */
    public function getLoyaltyCard(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemLoyaltyCard
    {
     ...
     * @return $this
     */
    public function setLoyaltyCard(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemLoyaltyCard $loyalty_card): static
    {
