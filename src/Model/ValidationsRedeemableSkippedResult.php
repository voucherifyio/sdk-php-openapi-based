...
/**
 * ValidationsRedeemableSkippedResult Class Doc Comment
 *
 ...
 */
class ValidationsRedeemableSkippedResult implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ValidationsRedeemableSkipped_result';
    ...
    */
     ...
     */
    public function getDetails(): ?\OpenAPI\Client\Model\ValidationsRedeemableSkippedResultDetails
    {
     ...
     * @return $this
     */
    public function setDetails(?\OpenAPI\Client\Model\ValidationsRedeemableSkippedResultDetails $details): static
    {
        if (is_null($details)) {
