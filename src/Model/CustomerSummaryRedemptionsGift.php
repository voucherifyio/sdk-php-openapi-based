...
class CustomerSummaryRedemptionsGift implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerSummaryRedemptions_gift';
    ...
    */
     ...
     * @return $this
     */
    public function setRedeemedAmount(?int $redeemed_amount): static
    {
     ...
     * @return int|null
     */
    public function getAmountToGo(): ?int
    {
     ...
     * @return $this
     */
    public function setAmountToGo(?int $amount_to_go): static
    {
