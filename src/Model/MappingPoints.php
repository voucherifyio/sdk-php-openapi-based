...
/**
 * MappingPoints Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MappingPoints implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MappingPoints';
    ...
    */
     ...
     * Sets multiplier
     *
     * @param float|null $multiplier Multiplication factor used to multiply the points to obtain the mapped points.
     *
     * @return $this
     */
     ...
     * Sets points
     *
     * @param int|null $points Fixed number of points to be applied.
     *
     * @return $this
     */
