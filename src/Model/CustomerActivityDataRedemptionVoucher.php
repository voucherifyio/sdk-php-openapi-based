...
/**
 * CustomerActivityDataRedemptionVoucher Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomerActivityDataRedemptionVoucher implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerActivityDataRedemptionVoucher';
    ...
    */
     ...
     * Gets gift
     *
     * @return \OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherGift|null
     */
    public function getGift(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherGift
    {
     ...
     * Sets gift
     *
     * @param \OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherGift|null $gift gift
     *
     * @return $this
     */
    public function setGift(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherGift $gift): static
    {
        if (is_null($gift)) {
     ...
     * Gets loyalty_card
     *
     * @return \OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherLoyaltyCard|null
     */
    public function getLoyaltyCard(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherLoyaltyCard
    {
     ...
     * Sets loyalty_card
     *
     * @param \OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherLoyaltyCard|null $loyalty_card loyalty_card
     *
     * @return $this
     */
    public function setLoyaltyCard(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherLoyaltyCard $loyalty_card): static
    {
     ...
     */
    public function getPublish(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherPublish
    {
     ...
     * @return $this
     */
    public function setPublish(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherPublish $publish): static
    {
        if (is_null($publish)) {
     ...
     */
    public function getRedemption(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherRedemption
    {
     ...
     * @return $this
     */
    public function setRedemption(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionVoucherRedemption $redemption): static
    {
