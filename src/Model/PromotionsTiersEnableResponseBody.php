...
class PromotionsTiersEnableResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PromotionsTiersEnableResponseBody';
    ...
    */
     ...
     */
    public function getCampaign(): ?\OpenAPI\Client\Model\PromotionTierCampaign
    {
     ...
     * @return $this
     */
    public function setCampaign(?\OpenAPI\Client\Model\PromotionTierCampaign $campaign): static
    {
        if (is_null($campaign)) {
     ...
     */
    public function getSummary(): ?\OpenAPI\Client\Model\PromotionTierSummary
    {
     ...
     * @return $this
     */
    public function setSummary(?\OpenAPI\Client\Model\PromotionTierSummary $summary): static
    {
        if (is_null($summary)) {
