 ...
 */
class AsyncAction implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AsyncAction';
    ...
    */
    ...
    public function setProgress(?int $progress): static
    {
        ...
        if (!is_null($progress) && ($progress > 100)) {
            throw new InvalidArgumentException('invalid value for $progress when calling AsyncAction., must be smaller than or equal to 100.');
        }
        if (!is_null($progress) && ($progress < 0)) {
            throw new InvalidArgumentException('invalid value for $progress when calling AsyncAction., must be bigger than or equal to 0.');
        }
