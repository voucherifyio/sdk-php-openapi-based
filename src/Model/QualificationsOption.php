...
class QualificationsOption implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'QualificationsOption';
    ...
    */
     ...
     */
    public function getStartingAfter(): ?\DateTime
    {
     ...
     * @return $this
     */
    public function setStartingAfter(?\DateTime $starting_after): static
    {
     ...
     */
    public function getFilters(): ?\OpenAPI\Client\Model\QualificationsOptionFilters
    {
     ...
     * @return $this
     */
    public function setFilters(?\OpenAPI\Client\Model\QualificationsOptionFilters $filters): static
    {
        if (is_null($filters)) {
     ...
     * @return string|null
     */
    public function getSortingRule(): ?string
    {
     ...
     * @return $this
     */
    public function setSortingRule(?string $sorting_rule): static
    {
