 ...
 */
class PromotionsStacksUpdateResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PromotionsStacksUpdateResponseBody';
