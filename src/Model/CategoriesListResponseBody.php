...
/**
 * CategoriesListResponseBody Class Doc Comment
 *
 ...
 */
class CategoriesListResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CategoriesListResponseBody';
    ...
    protected static array $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'data' => '\OpenAPI\Client\Model\Category[]',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about categories in a dictionary.
     *
     * @return $this
     */
     ...
     * Sets data_ref
     *
     * @param string|null $data_ref Identifies the name of the attribute that contains the array of category objects.
     *
     * @return $this
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Category[]|null $data data
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int|null $total Total number of categories.
     *
     * @return $this
     */
