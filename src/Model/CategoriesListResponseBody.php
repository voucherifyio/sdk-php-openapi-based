...
class CategoriesListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets object
     *
     * @param string $object The type of object represented by JSON. This object stores information about categories in a dictionary.
     *
     * @return self
     */
     ...
     * Sets data_ref
     *
     * @param string $data_ref Identifies the name of the attribute that contains the array of category objects.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Category[] $data data
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total Total number of categories.
     *
     * @return self
     */
