...
/**
 * ValidationRulesListResponseBody Class Doc Comment
 *
 ...
 */
class ValidationRulesListResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ValidationRulesListResponseBody';
    ...
    protected static array $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'data' => '\OpenAPI\Client\Model\ValidationRule[]',
        'total' => 'int'
    ];
