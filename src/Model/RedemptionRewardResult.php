...
class RedemptionRewardResult implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RedemptionRewardResult';
    ...
    */
     ...
     * Sets voucher
     *
     * @param \OpenAPI\Client\Model\Voucher|null $voucher Defines of the voucher.
     *
     * @return $this
     */
     ...
     */
    public function getProduct(): ?\OpenAPI\Client\Model\Product
    {
     ...
     * Sets product
     *
     * @param \OpenAPI\Client\Model\Product|null $product Defines of the product.
     *
     * @return $this
     */
    public function setProduct(?\OpenAPI\Client\Model\Product $product): static
    {
        if (is_null($product)) {
     ...
     */
    public function getSku(): ?\OpenAPI\Client\Model\Sku
    {
     ...
     * Sets sku
     *
     * @param \OpenAPI\Client\Model\Sku|null $sku Defines of the sku.
     *
     * @return $this
     */
    public function setSku(?\OpenAPI\Client\Model\Sku $sku): static
    {
        if (is_null($sku)) {
     ...
     */
    public function getParameters(): ?\OpenAPI\Client\Model\RedemptionRewardResultParameters
    {
     ...
     * @return $this
     */
    public function setParameters(?\OpenAPI\Client\Model\RedemptionRewardResultParameters $parameters): static
    {
