...
/**
 * AreaStoreCampaignAssignment Class Doc Comment
 *
 ...
 */
class AreaStoreCampaignAssignment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AreaStoreCampaignAssignment';
    ...
    public const OBJECT_AREA_STORE_CAMPAIGN_ASSIGNMENT = 'area_store_campaign_assignment';
    ...
    {
        return [
            self::OBJECT_AREA_STORE_CAMPAIGN_ASSIGNMENT,
        ];
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier of the campaign assignment.
     *
     * @return $this
     */
     ...
     * @return string|null
     */
    public function getAreaStoreId(): ?string
    {
     ...
     * @return $this
     */
    public function setAreaStoreId(?string $area_store_id): static
    {
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about the campaign assignment to areas or stores.
     *
     * @return $this
     */
