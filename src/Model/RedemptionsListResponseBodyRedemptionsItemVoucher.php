...
/**
 * RedemptionsListResponseBodyRedemptionsItemVoucher Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RedemptionsListResponseBodyRedemptionsItemVoucher implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Redemptions_List_Response_Body_Redemptions_ItemVoucher';
    ...
    */
     ...
     * Gets gift
     *
     * @return \OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherGift|null
     */
    public function getGift(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherGift
    {
     ...
     * Sets gift
     *
     * @param \OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherGift|null $gift gift
     *
     * @return $this
     */
    public function setGift(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherGift $gift): static
    {
        if (is_null($gift)) {
     ...
     * Gets loyalty_card
     *
     * @return \OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard|null
     */
    public function getLoyaltyCard(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard
    {
     ...
     * Sets loyalty_card
     *
     * @param \OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard|null $loyalty_card loyalty_card
     *
     * @return $this
     */
    public function setLoyaltyCard(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard $loyalty_card): static
    {
     ...
     */
    public function getPublish(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherPublish
    {
     ...
     * Sets publish
     *
     * @param \OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherPublish|null $publish publish
     *
     * @return $this
     */
    public function setPublish(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherPublish $publish): static
    {
        if (is_null($publish)) {
     ...
     * Gets redemption
     *
     * @return \OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherRedemption|null
     */
    public function getRedemption(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherRedemption
    {
     ...
     * Sets redemption
     *
     * @param \OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherRedemption|null $redemption redemption
     *
     * @return $this
     */
    public function setRedemption(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemVoucherRedemption $redemption): static
    {
