...
/**
 * LoyaltyTierAllOfConfigPoints Class Doc Comment
 *
 ...
 */
class LoyaltyTierAllOfConfigPoints implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LoyaltyTier_allOf_config_points';
    ...
    */
     ...
     * Sets from
     *
     * @param int|null $from Bottom points threshold value.
     *
     * @return $this
     */
     ...
     * Sets to
     *
     * @param int|null $to Top points threshold value.
     *
     * @return $this
     */
