 ...
 */
class LoyaltiesMembersTransactionsExportCreateResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LoyaltiesMembersTransactionsExportCreateResponseBody';
