...
class CustomerSummaryRedemptions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerSummaryRedemptions';
    ...
    */
     ...
     * @return $this
     */
    public function setTotalRedeemed(?int $total_redeemed): static
    {
     ...
     * @return $this
     */
    public function setTotalFailed(?int $total_failed): static
    {
     ...
     * @return int|null
     */
    public function getTotalSucceeded(): ?int
    {
     ...
     * @return $this
     */
    public function setTotalSucceeded(?int $total_succeeded): static
    {
     ...
     * @return int|null
     */
    public function getTotalRolledBack(): ?int
    {
     ...
     * @return $this
     */
    public function setTotalRolledBack(?int $total_rolled_back): static
    {
     ...
     * @return int|null
     */
    public function getTotalRollbackFailed(): ?int
    {
     ...
     * @return $this
     */
    public function setTotalRollbackFailed(?int $total_rollback_failed): static
    {
     ...
     * @return int|null
     */
    public function getTotalRollbackSucceeded(): ?int
    {
     ...
     * @return $this
     */
    public function setTotalRollbackSucceeded(?int $total_rollback_succeeded): static
    {
     ...
     */
    public function getGift(): ?\OpenAPI\Client\Model\CustomerSummaryRedemptionsGift
    {
     ...
     * @return $this
     */
    public function setGift(?\OpenAPI\Client\Model\CustomerSummaryRedemptionsGift $gift): static
    {
        if (is_null($gift)) {
     ...
     */
    public function getLoyaltyCard(): ?\OpenAPI\Client\Model\CustomerSummaryRedemptionsLoyaltyCard
    {
     ...
     * @return $this
     */
    public function setLoyaltyCard(?\OpenAPI\Client\Model\CustomerSummaryRedemptionsLoyaltyCard $loyalty_card): static
    {
