...
class PublicationsCreateRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PublicationsCreateRequestBody';
    ...
    */
     ...
     */
    public function getCustomer(): ?\OpenAPI\Client\Model\PublicationsCreateRequestBodyCustomer
    {
     ...
     * @return $this
     */
    public function setCustomer(?\OpenAPI\Client\Model\PublicationsCreateRequestBodyCustomer $customer): static
    {
        if (is_null($customer)) {
     ...
     */
    public function getCampaign(): ?\OpenAPI\Client\Model\CreatePublicationCampaign
    {
     ...
     * @return $this
     */
    public function setCampaign(?\OpenAPI\Client\Model\CreatePublicationCampaign $campaign): static
    {
        if (is_null($campaign)) {
