...
/**
 * LoyaltiesRewardsListAssignmentsResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesRewardsListAssignmentsResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesRewardsListAssignmentsResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'data' => '\OpenAPI\Client\Model\RewardAssignment[]',
        'total' => 'int'
    ];
...
<<<<<<< Updated upstream:src/Model/ProductCollectionsProductsList.php
...
>>>>>>> Stashed changes:src/Model/LoyaltiesRewardsListAssignmentsResponseBody.php
     ...
     *
<<<<<<< Updated upstream:src/Model/ProductCollectionsProductsList.php
     * @param string $object The type of object represented by JSON. This object stores information about products and SKUs.
=======
...
>>>>>>> Stashed changes:src/Model/LoyaltiesRewardsListAssignmentsResponseBody.php
     ...
     *
<<<<<<< Updated upstream:src/Model/ProductCollectionsProductsList.php
     * @param string $data_ref Identifies the name of the JSON property that contains the array of products and SKUs.
=======
...
>>>>>>> Stashed changes:src/Model/LoyaltiesRewardsListAssignmentsResponseBody.php
     ...
     *
<<<<<<< Updated upstream:src/Model/ProductCollectionsProductsList.php
     * @param int $total Total number of products & SKUs in the product collection.
=======
