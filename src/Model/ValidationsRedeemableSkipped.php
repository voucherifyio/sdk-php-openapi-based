...
class ValidationsRedeemableSkipped implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ValidationsRedeemableSkipped';
    ...
    */
     ...
     */
    public function getResult(): ?\OpenAPI\Client\Model\ValidationsRedeemableSkippedResult
    {
     ...
     * @return $this
     */
    public function setResult(?\OpenAPI\Client\Model\ValidationsRedeemableSkippedResult $result): static
    {
        if (is_null($result)) {
