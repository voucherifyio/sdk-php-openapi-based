...
class ValidationsValidateResponseBodyRedeemablesItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Validations_Validate_Response_Body_Redeemables_Item';
    ...
    */
     ...
     */
    public function getResult(): ?\OpenAPI\Client\Model\ValidationsValidateResponseBodyRedeemablesItemResult
    {
     ...
     * @return $this
     */
    public function setResult(?\OpenAPI\Client\Model\ValidationsValidateResponseBodyRedeemablesItemResult $result): static
    {
        if (is_null($result)) {
