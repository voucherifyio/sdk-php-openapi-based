...
/**
 * ApplicableTo Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicableTo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicableTo';
    ...
    */
     ...
     * @return $this
     */
    public function setProductSourceId(?string $product_source_id): static
    {
     ...
     * @return $this
     */
    public function setPriceFormula(?float $price_formula): static
    {
     ...
     * @return $this
     */
    public function setQuantityLimit(?int $quantity_limit): static
    {
     ...
     * @return int|null
     */
    public function getAggregatedQuantityLimit(): ?int
    {
     ...
     * @return $this
     */
    public function setAggregatedQuantityLimit(?int $aggregated_quantity_limit): static
    {
     ...
     * @return $this
     */
    public function setAmountLimit(?int $amount_limit): static
    {
     ...
     * @return int[]|null
     */
    public function getOrderItemIndices(): ?array
    {
     ...
     * @return $this
     */
    public function setOrderItemIndices(?array $order_item_indices): static
    {
