...
/**
 * SimplePromotionTier Class Doc Comment
 *
 ...
 */
class SimplePromotionTier implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SimplePromotionTier';
    ...
    */
     ...
     */
    public function getCampaign(): ?\OpenAPI\Client\Model\SimplePromotionTierCampaign
    {
     ...
     * @return $this
     */
    public function setCampaign(?\OpenAPI\Client\Model\SimplePromotionTierCampaign $campaign): static
    {
        if (is_null($campaign)) {
