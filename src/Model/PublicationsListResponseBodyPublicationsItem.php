...
class PublicationsListResponseBodyPublicationsItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Publications_List_Response_Body_Publications_Item';
    ...
    */
     ...
     */
    public function getMetadata(): ?\OpenAPI\Client\Model\PublicationsListResponseBodyPublicationsItemMetadata
    {
     ...
     * @return $this
     */
    public function setMetadata(?\OpenAPI\Client\Model\PublicationsListResponseBodyPublicationsItemMetadata $metadata): static
    {
        if (is_null($metadata)) {
