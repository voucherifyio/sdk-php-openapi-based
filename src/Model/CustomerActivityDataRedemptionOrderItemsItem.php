...
class CustomerActivityDataRedemptionOrderItemsItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerActivityDataRedemptionOrderItemsItem';
    ...
    */
    ...
    public function setInitialQuantity($initial_quantity)
    {
        if (is_null($initial_quantity)) {
            throw new \InvalidArgumentException('non-nullable initial_quantity cannot be null');
        }
