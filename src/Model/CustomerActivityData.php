...
class CustomerActivityData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerActivity_data';
    ...
    protected static array $openAPITypes = [
        ...
        'event_source' => '\OpenAPI\Client\Model\CustomerActivityDataEventSource'
    ];
    ...
    */
     ...
     * Gets event_source
     *
     * @return \OpenAPI\Client\Model\CustomerActivityDataEventSource|null
     */
    public function getEventSource(): ?\OpenAPI\Client\Model\CustomerActivityDataEventSource
    {
     ...
     * Sets event_source
     *
     * @param \OpenAPI\Client\Model\CustomerActivityDataEventSource|null $event_source event_source
     *
     * @return $this
     */
    public function setEventSource(?\OpenAPI\Client\Model\CustomerActivityDataEventSource $event_source): static
    {
        if (is_null($event_source)) {
            array_push($this->openAPINullablesSetToNull, 'event_source');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('event_source', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
