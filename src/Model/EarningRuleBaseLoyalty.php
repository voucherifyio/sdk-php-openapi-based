...
/**
 * EarningRuleBaseLoyalty Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EarningRuleBaseLoyalty implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Earning_Rule_Base_Loyalty';
    ...
    protected static array $openAPITypes = [
        ...
        'order' => '\OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrder',
        'order_items' => '\OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrderItems',
        'customer' => '\OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomer',
        'custom_event' => '\OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomEvent',
        'points' => 'int'
    ];
    ...
    */
     ...
     * @return $this
     */
    public function setCalculationType(?string $calculation_type): static
    {
     ...
     * Gets order
     *
     * @return \OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrder|null
     */
    public function getOrder(): ?\OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrder
    {
     ...
     * Sets order
     *
     * @param \OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrder|null $order order
     *
     * @return $this
     */
    public function setOrder(?\OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrder $order): static
    {
        if (is_null($order)) {
     ...
     * Gets order_items
     *
     * @return \OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrderItems|null
     */
    public function getOrderItems(): ?\OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrderItems
    {
     ...
     * Sets order_items
     *
     * @param \OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrderItems|null $order_items order_items
     *
     * @return $this
     */
    public function setOrderItems(?\OpenAPI\Client\Model\EarningRuleBaseLoyaltyOrderItems $order_items): static
    {
     ...
     * Gets customer
     *
     * @return \OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomer|null
     */
    public function getCustomer(): ?\OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomer
    {
     ...
     * Sets customer
     *
     * @param \OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomer|null $customer customer
     *
     * @return $this
     */
    public function setCustomer(?\OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomer $customer): static
    {
        if (is_null($customer)) {
     ...
     * Gets custom_event
     *
     * @return \OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomEvent|null
     */
    public function getCustomEvent(): ?\OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomEvent
    {
     ...
     * Sets custom_event
     *
     * @param \OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomEvent|null $custom_event custom_event
     *
     * @return $this
     */
    public function setCustomEvent(?\OpenAPI\Client\Model\EarningRuleBaseLoyaltyCustomEvent $custom_event): static
    {
