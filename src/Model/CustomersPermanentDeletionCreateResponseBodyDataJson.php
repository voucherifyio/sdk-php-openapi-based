...
class CustomersPermanentDeletionCreateResponseBodyDataJson implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomersPermanentDeletionCreateResponseBody_data_json';
    ...
    */
     ...
     * @return int|null
     */
    public function getCustomerEvents(): ?int
    {
     ...
     * @return $this
     */
    public function setCustomerEvents(?int $customer_events): static
    {
     ...
     * @return int|null
     */
    public function getDailyEvents(): ?int
    {
     ...
     * @return $this
     */
    public function setDailyEvents(?int $daily_events): static
    {
     ...
     * @return $this
     */
    public function setSegments(?int $segments): static
    {
        if (is_null($segments)) {
     ...
     * @return int|null
     */
    public function getOrderEvents(): ?int
    {
     ...
     * @return $this
     */
    public function setOrderEvents(?int $order_events): static
    {
