...
class CustomerActivityDataRedemptionOrder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerActivityDataRedemptionOrder';
    ...
    */
     ...
     */
    public function getCustomer(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionOrderCustomer
    {
     ...
     * @return $this
     */
    public function setCustomer(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionOrderCustomer $customer): static
    {
        if (is_null($customer)) {
     ...
     */
    public function getReferrer(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionOrderReferrer
    {
     ...
     * @return $this
     */
    public function setReferrer(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionOrderReferrer $referrer): static
    {
        if (is_null($referrer)) {
