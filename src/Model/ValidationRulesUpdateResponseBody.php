...
/**
 * ValidationRulesUpdateResponseBody Class Doc Comment
 *
 ...
 */
class ValidationRulesUpdateResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ValidationRulesUpdateResponseBody';
    ...
    */
     ...
     */
    public function getError(): ?\OpenAPI\Client\Model\ValidationRuleBaseError
    {
     ...
     * @return $this
     */
    public function setError(?\OpenAPI\Client\Model\ValidationRuleBaseError $error): static
    {
        if (is_null($error)) {
     ...
     */
    public function getApplicableTo(): ?\OpenAPI\Client\Model\ValidationRuleBaseApplicableTo
    {
     ...
     * @return $this
     */
    public function setApplicableTo(?\OpenAPI\Client\Model\ValidationRuleBaseApplicableTo $applicable_to): static
    {
     ...
     * @return $this
     */
    public function setContextType(?string $context_type): static
    {
     ...
     * @return $this
     */
    public function setAssignmentsCount(?int $assignments_count): static
    {
