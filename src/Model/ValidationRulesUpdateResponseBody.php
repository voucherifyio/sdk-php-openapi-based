...
class ValidationRulesUpdateResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidationRulesUpdateResponseBody';
    ...
    */
     ...
     * Gets error
     *
     * @return \OpenAPI\Client\Model\ValidationRulesUpdateResponseBodyError|null
     */
     ...
     * Sets error
     *
     * @param \OpenAPI\Client\Model\ValidationRulesUpdateResponseBodyError|null $error error
     *
     * @return self
     */
