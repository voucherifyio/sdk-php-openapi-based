...
class DiscountUnitMultipleOneUnit implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DiscountUnitMultipleOneUnit';
    ...
    */
     ...
     * @return float|null
     */
    public function getUnitOff(): ?float
    {
     ...
     * @return $this
     */
    public function setUnitOff(?float $unit_off): static
    {
        if (is_null($unit_off)) {
     ...
     */
    public function getProduct(): ?\OpenAPI\Client\Model\SimpleProductDiscountUnit
    {
     ...
     * Sets product
     *
     * @param \OpenAPI\Client\Model\SimpleProductDiscountUnit|null $product Contains information about the product.
     *
     * @return $this
     */
    public function setProduct(?\OpenAPI\Client\Model\SimpleProductDiscountUnit $product): static
    {
        if (is_null($product)) {
     ...
     * Sets sku
     *
     * @param \OpenAPI\Client\Model\SimpleSkuDiscountUnit|null $sku Contains information about the sku.
     *
     * @return $this
     */
