 ...
 */
class LoyaltiesMembersPointsExpirationListResponseBodyDataItemBucket implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Loyalties_Members_Points_Expiration_List_Response_Body_Data_Item_bucket';
    ...
    */
    ...
    public function setTotalPoints(int $total_points): static
    {
        if (is_null($total_points)) {
            array_push($this->openAPINullablesSetToNull, 'total_points');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('total_points', $nullablesSetToNull);
            if ($index !== FALSE) {
