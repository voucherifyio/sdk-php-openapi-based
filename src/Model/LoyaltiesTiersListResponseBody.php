...
/**
 * LoyaltiesTiersListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesTiersListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesTiersListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'data' => '\OpenAPI\Client\Model\LoyaltyTier[]',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\LoyaltyTier[] $data This is an object representing a loyalty tier. Loyalty tiers are used to create a loyalty program with different levels of membership and varied earning rules and rewards based on customer’s tiers.
     *
     * @return self
     */
