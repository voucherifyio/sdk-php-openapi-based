 ...
 */
class ValidationsRedeemableInapplicableResult implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ValidationsRedeemableInapplicable_result';
    ...
    */
     ...
     */
    public function getDetails(): ?\OpenAPI\Client\Model\ValidationsRedeemableInapplicableResultDetails
    {
     ...
     * @return $this
     */
    public function setDetails(?\OpenAPI\Client\Model\ValidationsRedeemableInapplicableResultDetails $details): static
    {
        if (is_null($details)) {
