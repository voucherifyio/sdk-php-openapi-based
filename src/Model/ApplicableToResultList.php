...
class ApplicableToResultList implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicableToResultList';
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ApplicableTo[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ApplicableTo[]|null $data Contains array of items to which the discount can apply.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int|null $total Total number of objects defining included products, SKUs, or product collections.
     *
     * @return $this
     */
