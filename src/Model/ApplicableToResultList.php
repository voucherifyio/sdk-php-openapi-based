...
/**
 * ApplicableToResultList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicableToResultList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicableToResultList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ApplicableTo[]',
        'total' => 'int',
        'object' => 'string',
        'data_ref' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ApplicableTo[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ApplicableTo[] $data Contains array of items to which the discount can apply.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total Total number of objects defining included products, SKUs, or product collections.
     *
     * @return self
     */
    public function setTotal($total)
    {
        ...
        if (($total < 0)) {
            throw new \InvalidArgumentException('invalid value for $total when calling ApplicableToResultList., must be bigger than or equal to 0.');
        }
     ...
     * Sets data_ref
     *
     * @param string $data_ref The type of object represented by JSON.
     *
     * @return self
     */
