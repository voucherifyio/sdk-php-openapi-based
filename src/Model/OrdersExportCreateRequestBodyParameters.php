...
class OrdersExportCreateRequestBodyParameters implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrdersExportCreateRequestBody_parameters';
    ...
    */
     ...
     * Sets filters
     *
     * @param object|null $filters Filter conditions.
     *
     * @return $this
     */
    public function setFilters(?object $filters): static
    {
        if (is_null($filters)) {
