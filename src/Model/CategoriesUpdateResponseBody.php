 ...
 */
class CategoriesUpdateResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CategoriesUpdateResponseBody';
