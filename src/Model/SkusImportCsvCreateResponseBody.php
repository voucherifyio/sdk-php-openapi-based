 ...
 */
class SkusImportCsvCreateResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SkusImportCsvCreateResponseBody';
