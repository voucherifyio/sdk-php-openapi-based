 ...
 */
class CampaignsListResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CampaignsListResponseBody';
    ...
    */
     ...
     * Sets campaigns
     *
     * @param \OpenAPI\Client\Model\CampaignBase[]|null $campaigns Contains array of campaign objects.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int|null $total Total number of campaigns.
     *
     * @return $this
     */
