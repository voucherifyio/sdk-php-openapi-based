 ...
 */
class AccessSettingsCampaignAssignmentsList implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AccessSettingsCampaignAssignmentsList';
    ...
    protected static array $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'data' => '\OpenAPI\Client\Model\AreaStoreCampaignAssignment[]',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. Default is `list`. This object stores information about campaign assignments to areas and stores
     *
     * @return $this
     */
     ...
     * Sets data_ref
     *
     * @param string|null $data_ref Identifies the name of the attribute that contains the array of campaign assignments.
     *
     * @return $this
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\AreaStoreCampaignAssignment[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\AreaStoreCampaignAssignment[]|null $data Contains an array of campaign assignments.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int|null $total Total number of areas and stores to which the campaign is assigned.
     *
     * @return $this
     */
    public function setTotal(?int $total): static
    {
        ...
        if (!is_null($total) && ($total < 0)) {
            throw new InvalidArgumentException('invalid value for $total when calling AccessSettingsCampaignAssignmentsList., must be bigger than or equal to 0.');
        }
