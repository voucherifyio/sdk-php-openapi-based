...
/**
 * OrdersUpdateResponseBody Class Doc Comment
 *
 ...
 */
class OrdersUpdateResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrdersUpdateResponseBody';
    ...
    protected static array $openAPITypes = [
        ...
        'referrer' => '\OpenAPI\Client\Model\CustomerId'
    ];
    ...
    */
     ...
     */
    public function getCustomer(): ?\OpenAPI\Client\Model\CustomerId
    {
     ...
     * @return $this
     */
    public function setCustomer(?\OpenAPI\Client\Model\CustomerId $customer): static
    {
        if (is_null($customer)) {
     ...
     * @return \OpenAPI\Client\Model\CustomerId|null
     */
    public function getReferrer(): ?\OpenAPI\Client\Model\CustomerId
    {
     ...
     * Sets referrer
     *
     * @param \OpenAPI\Client\Model\CustomerId|null $referrer referrer
     *
     * @return $this
     */
    public function setReferrer(?\OpenAPI\Client\Model\CustomerId $referrer): static
    {
        if (is_null($referrer)) {
