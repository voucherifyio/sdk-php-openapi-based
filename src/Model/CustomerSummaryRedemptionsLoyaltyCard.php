...
class CustomerSummaryRedemptionsLoyaltyCard implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerSummaryRedemptions_loyalty_card';
    ...
    */
     ...
     * @return int|null
     */
    public function getPointsToGo(): ?int
    {
     ...
     * @return $this
     */
    public function setPointsToGo(?int $points_to_go): static
    {
