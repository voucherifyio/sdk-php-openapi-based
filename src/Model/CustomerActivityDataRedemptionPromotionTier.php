...
/**
 * CustomerActivityDataRedemptionPromotionTier Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomerActivityDataRedemptionPromotionTier implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerActivityDataRedemptionPromotionTier';
    ...
    */
     ...
     */
    public function getAction(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionPromotionTierAction
    {
     ...
     * @return $this
     */
    public function setAction(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionPromotionTierAction $action): static
    {
        if (is_null($action)) {
     ...
     */
    public function getCampaign(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionPromotionTierCampaign
    {
     ...
     * @return $this
     */
    public function setCampaign(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionPromotionTierCampaign $campaign): static
    {
        if (is_null($campaign)) {
     ...
     * Gets summary
     *
     * @return \OpenAPI\Client\Model\CustomerActivityDataRedemptionPromotionTierSummary|null
     */
    public function getSummary(): ?\OpenAPI\Client\Model\CustomerActivityDataRedemptionPromotionTierSummary
    {
     ...
     * Sets summary
     *
     * @param \OpenAPI\Client\Model\CustomerActivityDataRedemptionPromotionTierSummary|null $summary summary
     *
     * @return $this
     */
    public function setSummary(?\OpenAPI\Client\Model\CustomerActivityDataRedemptionPromotionTierSummary $summary): static
    {
        if (is_null($summary)) {
