...
class VoucherTransactionsFilters implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VoucherTransactionsFilters';
    ...
    */
     ...
     */
    public function getFilters(): \OpenAPI\Client\Model\VoucherTransactionsExportFilterConditions
    {
     ...
     * @return $this
     */
    public function setFilters(\OpenAPI\Client\Model\VoucherTransactionsExportFilterConditions $filters): static
    {
        if (is_null($filters)) {
