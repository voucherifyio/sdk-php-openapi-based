...
/**
 * LoyaltiesMembersTransfersCreateResponseBodyAssets Class Doc Comment
 *
 ...
 */
class LoyaltiesMembersTransfersCreateResponseBodyAssets implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LoyaltiesMembersTransfersCreateResponseBody_assets';
    ...
    */
     ...
     */
    public function getQr(): ?\OpenAPI\Client\Model\LoyaltiesMembersTransfersCreateResponseBodyAssetsQr
    {
     ...
     * @return $this
     */
    public function setQr(?\OpenAPI\Client\Model\LoyaltiesMembersTransfersCreateResponseBodyAssetsQr $qr): static
    {
        if (is_null($qr)) {
     ...
     */
    public function getBarcode(): ?\OpenAPI\Client\Model\LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode
    {
     ...
     * @return $this
     */
    public function setBarcode(?\OpenAPI\Client\Model\LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode $barcode): static
    {
        if (is_null($barcode)) {
