...
class CustomerLoyalty implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerLoyalty';
    ...
    */
     ...
     * Gets campaigns
     *
     * @return array<string,\OpenAPI\Client\Model\CustomerLoyaltyCampaignsValue>|null
     */
     ...
     * Sets campaigns
     *
     * @param array<string,\OpenAPI\Client\Model\CustomerLoyaltyCampaignsValue>|null $campaigns Contains campaigns with details about point balances and how many customers were referred by the customer.
     *
     * @return $this
     */
