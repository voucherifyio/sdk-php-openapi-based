...
/**
 * ProductCollectionsProductsListDataItem Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProductCollectionsProductsListDataItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Product_Collections_Products_List_Data_Item';
    ...
    */
     ...
     */
    public function getProduct(): ?\OpenAPI\Client\Model\ProductWithoutSkus
    {
     ...
     * @return $this
     */
    public function setProduct(?\OpenAPI\Client\Model\ProductWithoutSkus $product): static
    {
        if (is_null($product)) {
