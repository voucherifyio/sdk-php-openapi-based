...
/**
 * CustomerActivityDataRedemptionOrderReferrerReferrals Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerActivityDataRedemptionOrderReferrerReferrals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerActivityDataRedemptionOrderReferrerReferrals';
    ...
    protected static $openAPITypes = [
        'total' => 'int',
        'campaigns' => '\OpenAPI\Client\Model\CustomerReferralsCampaignsItem[]'
    ];
