...
class CampaignLoyaltyCardExpirationRules implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CampaignLoyaltyCard_expiration_rules';
    ...
    */
     ...
     * @return $this
     */
    public function setPeriodType(?string $period_type): static
    {
     ...
     * @return $this
     */
    public function setPeriodValue(?int $period_value): static
    {
     ...
     * @return $this
     */
    public function setRoundingType(?string $rounding_type): static
    {
     ...
     * @return $this
     */
    public function setRoundingValue(?int $rounding_value): static
    {
