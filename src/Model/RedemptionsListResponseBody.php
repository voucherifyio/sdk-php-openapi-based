...
/**
 * RedemptionsListResponseBody Class Doc Comment
 *
 ...
 */
class RedemptionsListResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RedemptionsListResponseBody';
    ...
    protected static array $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'redemptions' => '\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItem[]',
        'total' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('data_ref', $data ?? [], 'redemptions');
