...
class ClientValidationsValidateResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets redeemables
     *
     * @return \OpenAPI\Client\Model\ClientValidationsValidateResponseBodyRedeemablesItem[]
     */
     ...
     * Sets redeemables
     *
     * @param \OpenAPI\Client\Model\ClientValidationsValidateResponseBodyRedeemablesItem[] $redeemables Lists validation results of each redeemable. If a redeemable can be applied, the API returns `\"status\": \"APPLICABLE\"`.
     *
     * @return self
     */
