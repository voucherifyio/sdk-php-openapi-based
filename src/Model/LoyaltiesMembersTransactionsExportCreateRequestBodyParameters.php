...
/**
 * LoyaltiesMembersTransactionsExportCreateRequestBodyParameters Class Doc Comment
 *
 ...
 */
class LoyaltiesMembersTransactionsExportCreateRequestBodyParameters implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LoyaltiesMembersTransactionsExportCreateRequestBody_parameters';
    ...
    protected static array $openAPITypes = [
        'order' => 'string',
        'fields' => 'string[]',
        'filters' => '\OpenAPI\Client\Model\ExportVoucherTransactionsFilters'
    ];
    ...
    */
     ...
     * Gets filters
     *
     * @return \OpenAPI\Client\Model\ExportVoucherTransactionsFilters|null
     */
    public function getFilters(): ?\OpenAPI\Client\Model\ExportVoucherTransactionsFilters
    {
     ...
     * Sets filters
     *
     * @param \OpenAPI\Client\Model\ExportVoucherTransactionsFilters|null $filters Filter conditions.
     *
     * @return $this
     */
    public function setFilters(?\OpenAPI\Client\Model\ExportVoucherTransactionsFilters $filters): static
    {
        if (is_null($filters)) {
