...
class CustomerSummaryOrders implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerSummaryOrders';
    ...
    */
     ...
     * @return $this
     */
    public function setAverageAmount(?int $average_amount): static
    {
     ...
     * @return int|null
     */
    public function getLastOrderAmount(): ?int
    {
     ...
     * @return $this
     */
    public function setLastOrderAmount(?int $last_order_amount): static
    {
     ...
     * @return $this
     */
    public function setLastOrderDate(?\DateTime $last_order_date): static
    {
