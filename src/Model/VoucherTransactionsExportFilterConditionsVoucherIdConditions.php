 ...
 */
class VoucherTransactionsExportFilterConditionsVoucherIdConditions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VoucherTransactionsExportFilterConditions_voucher_id_conditions';
