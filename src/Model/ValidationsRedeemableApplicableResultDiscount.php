...
/**
 * ValidationsRedeemableApplicableResultDiscount Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ValidationsRedeemableApplicableResultDiscount implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Validations_Redeemable_Applicable_ResultDiscount';
    ...
    protected static array $openAPITypes = [
        ...
        'unit_type' => 'string',
        'product' => '\OpenAPI\Client\Model\ValidationsRedeemableApplicableResultDiscountProduct',
    ...
    */
     ...
     * Gets product
     *
     * @return \OpenAPI\Client\Model\ValidationsRedeemableApplicableResultDiscountProduct|null
     */
    public function getProduct(): ?\OpenAPI\Client\Model\ValidationsRedeemableApplicableResultDiscountProduct
    {
     ...
     * Sets product
     *
     * @param \OpenAPI\Client\Model\ValidationsRedeemableApplicableResultDiscountProduct|null $product product
     *
     * @return $this
     */
    public function setProduct(?\OpenAPI\Client\Model\ValidationsRedeemableApplicableResultDiscountProduct $product): static
    {
        if (is_null($product)) {
