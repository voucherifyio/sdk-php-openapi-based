...
class RedemptionsListResponseBodyRedemptionsItemOrder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Redemptions_List_Response_Body_Redemptions_ItemOrder';
    ...
    */
     ...
     */
    public function getCustomer(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemOrderCustomer
    {
     ...
     * @return $this
     */
    public function setCustomer(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemOrderCustomer $customer): static
    {
        if (is_null($customer)) {
     ...
     */
    public function getReferrer(): ?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemOrderReferrer
    {
     ...
     * @return $this
     */
    public function setReferrer(?\OpenAPI\Client\Model\RedemptionsListResponseBodyRedemptionsItemOrderReferrer $referrer): static
    {
        if (is_null($referrer)) {
