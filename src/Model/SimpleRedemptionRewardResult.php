...
/**
 * SimpleRedemptionRewardResult Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SimpleRedemptionRewardResult implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SimpleRedemptionRewardResult';
    ...
    protected static array $openAPITypes = [
        ...
        'product' => '\OpenAPI\Client\Model\SimpleProduct',
        'sku' => '\OpenAPI\Client\Model\SimpleSku',
    ...
    */
     ...
     * Sets voucher
     *
     * @param \OpenAPI\Client\Model\SimpleVoucher|null $voucher Defines of the voucher.
     *
     * @return $this
     */
     ...
     */
    public function getProduct(): ?\OpenAPI\Client\Model\SimpleProduct
    {
     ...
     * Sets product
     *
     * @param \OpenAPI\Client\Model\SimpleProduct|null $product Defines of the product.
     *
     * @return $this
     */
    public function setProduct(?\OpenAPI\Client\Model\SimpleProduct $product): static
    {
        if (is_null($product)) {
     ...
     */
    public function getSku(): ?\OpenAPI\Client\Model\SimpleSku
    {
     ...
     * Sets sku
     *
     * @param \OpenAPI\Client\Model\SimpleSku|null $sku Defines of the sku.
     *
     * @return $this
     */
    public function setSku(?\OpenAPI\Client\Model\SimpleSku $sku): static
    {
        if (is_null($sku)) {
     ...
     * Sets parameters
     *
     * @param object|null $parameters Defines how the reward is generated.
     *
     * @return $this
     */
