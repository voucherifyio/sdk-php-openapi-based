...
/**
 * LoyaltyTiersExpirationAllExpirationDate Class Doc Comment
 *
 ...
 */
class LoyaltyTiersExpirationAllExpirationDate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LoyaltyTiersExpirationAll_expiration_date';
    ...
    protected static array $openAPITypes = [
        'type' => 'string',
        'extend' => 'string',
        'rounding' => '\OpenAPI\Client\Model\LoyaltyTiersExpirationAllExpirationDateRounding'
    ];
    ...
    public const TYPE_END_OF_NEXT_PERIOD = 'END_OF_NEXT_PERIOD';
    public const TYPE_BALANCE_DROP = 'BALANCE_DROP';
    ...
    {
        return [
            self::TYPE_END_OF_PERIOD,
            self::TYPE_END_OF_NEXT_PERIOD,
            self::TYPE_BALANCE_DROP,
            self::TYPE_CUSTOM,
        ];
    }
    ...
    */
     ...
     * Gets rounding
     *
     * @return \OpenAPI\Client\Model\LoyaltyTiersExpirationAllExpirationDateRounding|null
     */
    public function getRounding(): ?\OpenAPI\Client\Model\LoyaltyTiersExpirationAllExpirationDateRounding
    {
     ...
     * Sets rounding
     *
     * @param \OpenAPI\Client\Model\LoyaltyTiersExpirationAllExpirationDateRounding|null $rounding rounding
     *
     * @return $this
     */
    public function setRounding(?\OpenAPI\Client\Model\LoyaltyTiersExpirationAllExpirationDateRounding $rounding): static
    {
        if (is_null($rounding)) {
