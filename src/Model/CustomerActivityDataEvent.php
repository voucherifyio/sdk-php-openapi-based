...
/**
 * CustomerActivityDataEvent Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomerActivityDataEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerActivityDataEvent';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique custom event ID.
     *
     * @return $this
     */
     ...
     * Gets customer
     *
     * @return \OpenAPI\Client\Model\SimpleCustomerRequiredObjectType|null
     */
     ...
     * Sets customer
     *
     * @param \OpenAPI\Client\Model\SimpleCustomerRequiredObjectType|null $customer A simple customer object
     *
     * @return $this
     */
     ...
     */
    public function getReferral(): ?\OpenAPI\Client\Model\CustomerActivityDataEventReferral
    {
     ...
     * @return $this
     */
    public function setReferral(?\OpenAPI\Client\Model\CustomerActivityDataEventReferral $referral): static
    {
        if (is_null($referral)) {
     ...
     */
    public function getLoyalty(): ?\OpenAPI\Client\Model\CustomerActivityDataEventLoyalty
    {
     ...
     * @return $this
     */
    public function setLoyalty(?\OpenAPI\Client\Model\CustomerActivityDataEventLoyalty $loyalty): static
    {
        if (is_null($loyalty)) {
