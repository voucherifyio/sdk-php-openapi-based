 ...
 */
class ClientEventsCreateRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ClientEventsCreateRequestBody';
    ...
    */
    ...
    public function setEvent(?string $event): static
    {
        ...
        if (!is_null($event) && (mb_strlen($event) > 300)) {
            throw new InvalidArgumentException('invalid length for $event when calling ClientEventsCreateRequestBody., must be smaller than or equal to 300.');
        }
        if (!is_null($event) && (mb_strlen($event) < 1)) {
            throw new InvalidArgumentException('invalid length for $event when calling ClientEventsCreateRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets customer
     *
     * @param \OpenAPI\Client\Model\Customer $customer Customer's information.
     *
     * @return $this
     */
     ...
     */
    public function getReferral(): ?\OpenAPI\Client\Model\ClientEventsCreateRequestBodyReferral
    {
     ...
     * @return $this
     */
    public function setReferral(?\OpenAPI\Client\Model\ClientEventsCreateRequestBodyReferral $referral): static
    {
        if (is_null($referral)) {
     ...
     */
    public function getLoyalty(): ?\OpenAPI\Client\Model\ClientEventsCreateRequestBodyLoyalty
    {
     ...
     * @return $this
     */
    public function setLoyalty(?\OpenAPI\Client\Model\ClientEventsCreateRequestBodyLoyalty $loyalty): static
    {
        if (is_null($loyalty)) {
     ...
     * Sets metadata
     *
     * @param object|null $metadata The metadata object stores all custom attributes assigned to the event. A set of key/value pairs that you can attach to an event object. It can be useful for storing additional information about the event in a structured format. Event metadata schema is defined in the **Dashboard** > **Project Settings** > **Event Schema** > **Edit particular event** > **Metadata property definition**.
     *
     * @return $this
     */
