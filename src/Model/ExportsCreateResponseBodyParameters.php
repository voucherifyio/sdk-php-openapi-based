...
class ExportsCreateResponseBodyParameters implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ExportsCreateResponseBodyParameters';
    ...
    */
     ...
     */
    public function getFilters(): ?\OpenAPI\Client\Model\ExportsCreateResponseBodyParametersFilters
    {
     ...
     * @return $this
     */
    public function setFilters(?\OpenAPI\Client\Model\ExportsCreateResponseBodyParametersFilters $filters): static
    {
        if (is_null($filters)) {
