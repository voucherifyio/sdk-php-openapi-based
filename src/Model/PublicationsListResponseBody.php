 ...
 */
class PublicationsListResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PublicationsListResponseBody';
    ...
    protected static array $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'publications' => '\OpenAPI\Client\Model\PublicationsListResponseBodyPublicationsItem[]',
        'total' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('data_ref', $data ?? [], 'publications');
