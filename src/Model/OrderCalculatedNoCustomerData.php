...
/**
 * OrderCalculatedNoCustomerData Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class OrderCalculatedNoCustomerData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderCalculatedNoCustomerData';
    ...
    */
     ...
     */
    public function getReferrer(): ?\OpenAPI\Client\Model\ReferrerId
    {
     ...
     * @return $this
     */
    public function setReferrer(?\OpenAPI\Client\Model\ReferrerId $referrer): static
    {
        if (is_null($referrer)) {
