...
/**
 * ValidationsRedeemableApplicable Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ValidationsRedeemableApplicable implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ValidationsRedeemableApplicable';
    ...
    protected static array $openAPITypes = [
        ...
        'result' => '\OpenAPI\Client\Model\ValidationsRedeemableApplicableResult',
        'metadata' => 'object',
    ...
    {
        $this->setIfExists('status', $data ?? [], 'APPLICABLE');
    ...
    */
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\ValidationsRedeemableApplicableResult|null
     */
    public function getResult(): ?\OpenAPI\Client\Model\ValidationsRedeemableApplicableResult
    {
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\ValidationsRedeemableApplicableResult|null $result result
     *
     * @return $this
     */
    public function setResult(?\OpenAPI\Client\Model\ValidationsRedeemableApplicableResult $result): static
    {
        if (is_null($result)) {
