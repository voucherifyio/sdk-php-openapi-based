...
/**
 * RewardsCreateRequestBodyParametersCoin Class Doc Comment
 *
 ...
 */
class RewardsCreateRequestBodyParametersCoin implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RewardsCreateRequestBodyParameters_coin';
    ...
    */
     ...
     * Sets exchange_ratio
     *
     * @param string|null $exchange_ratio The cash equivalent of the points defined in the `points_ratio` property.
     *
     * @return $this
     */
    public function setExchangeRatio(?string $exchange_ratio): static
    {
     ...
     * @return string|null
     */
    public function getPointsRatio(): ?string
    {
     ...
     * Sets points_ratio
     *
     * @param string|null $points_ratio The number of loyalty points that will map to the predefined cash amount defined by the `exchange_ratio` property.
     *
     * @return $this
     */
    public function setPointsRatio(?string $points_ratio): static
    {
