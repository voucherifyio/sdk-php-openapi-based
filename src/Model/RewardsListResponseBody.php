...
/**
 * RewardsListResponseBody Class Doc Comment
 *
 ...
 */
class RewardsListResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RewardsListResponseBody';
    ...
    protected static array $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'data' => '\OpenAPI\Client\Model\Reward[]',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Reward[]|null $data A dictionary that contains an array of rewards. Each entry in the array is a separate transaction object.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int|null $total Returns how many rewards in the project meet the limits defined by the query parameter definitions.
     *
     * @return $this
     */
