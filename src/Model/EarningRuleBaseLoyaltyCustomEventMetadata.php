...
/**
 * EarningRuleBaseLoyaltyCustomEventMetadata Class Doc Comment
 *
 ...
 */
class EarningRuleBaseLoyaltyCustomEventMetadata implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Earning_Rule_Base_Loyalty_custom_event_metadata';
    ...
    */
     ...
     * Sets every
     *
     * @param int|null $every For how many increments of the customer metadata property to grant points for.
     *
     * @return $this
     */
     ...
     * Sets property
     *
     * @param string|null $property Custom event metadata property.
     *
     * @return $this
     */
