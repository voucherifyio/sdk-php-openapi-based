 ...
 *
 * @description This is an object representing a product.    This entity should be used to map product items from your inventory management system. The aim of products is to build which reflect product-specific campaigns.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Product implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     */
    public function getSkus(): ?\OpenAPI\Client\Model\SkusListForProduct
    {
     ...
     * @return $this
     */
    public function setSkus(?\OpenAPI\Client\Model\SkusListForProduct $skus): static
    {
        if (is_null($skus)) {
