...
class RedemptionsGetResponseBodyOrder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RedemptionsGetResponseBodyOrder';
    ...
    */
     ...
     */
    public function getCustomer(): ?\OpenAPI\Client\Model\RedemptionsGetResponseBodyOrderCustomer
    {
     ...
     * @return $this
     */
    public function setCustomer(?\OpenAPI\Client\Model\RedemptionsGetResponseBodyOrderCustomer $customer): static
    {
        if (is_null($customer)) {
     ...
     */
    public function getReferrer(): ?\OpenAPI\Client\Model\RedemptionsGetResponseBodyOrderReferrer
    {
     ...
     * @return $this
     */
    public function setReferrer(?\OpenAPI\Client\Model\RedemptionsGetResponseBodyOrderReferrer $referrer): static
    {
        if (is_null($referrer)) {
