...
/**
 * VoucherTransactionDetailsBalanceRelatedObject Class Doc Comment
 *
 ...
 */
class VoucherTransactionDetailsBalanceRelatedObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VoucherTransaction_details_balance_related_object';
    ...
    */
    ...
    public function setType(?string $type): static
    {
        ...
        if (!is_null($type) && (!preg_match("/voucher/", ObjectSerializer::toString($type)))) {
