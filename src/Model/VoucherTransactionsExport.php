...
class VoucherTransactionsExport implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VoucherTransactionsExport';
    ...
    */
     ...
     */
    public function getParameters(): \OpenAPI\Client\Model\VoucherTransactionsFilters
    {
     ...
     * @return $this
     */
    public function setParameters(\OpenAPI\Client\Model\VoucherTransactionsFilters $parameters): static
    {
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\VoucherTransactionsExportResult|null
     */
    public function getResult(): ?\OpenAPI\Client\Model\VoucherTransactionsExportResult
    {
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\VoucherTransactionsExportResult|null $result result
     *
     * @return $this
     */
    public function setResult(?\OpenAPI\Client\Model\VoucherTransactionsExportResult $result): static
    {
        if (is_null($result)) {
