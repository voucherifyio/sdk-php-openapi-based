...
/**
 * LoyaltiesTiersEarningRulesListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesTiersEarningRulesListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesTiersEarningRulesListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data_ref' => 'string',
        'data' => '\OpenAPI\Client\Model\EarningRule[]',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets object
     *
     * @param string $object The type of object represented by JSON. This object stores information about earning rules in a dictionary.
     *
     * @return self
     */
     ...
     * Sets data_ref
     *
     * @param string $data_ref Identifies the name of the attribute that contains the array of earning rule objects.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\EarningRule[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\EarningRule[] $data Contains array of earning rule objects.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total Total number of earning rule objects.
     *
     * @return self
     */
